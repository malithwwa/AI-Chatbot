...
import { LuSparkles, LuMapPin } from 'react-icons/lu';
...
const ChatBot = () => {
   ...
   return (
         ...
         <div className="flex h-full w-full max-w-xl flex-col overflow-hidden bg-slate-50 shadow-xl sm:h-full sm:max-h-full sm:rounded-[20px] sm:border sm:border-sky-100">
            {/* Header */}
